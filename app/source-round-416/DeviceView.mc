...
class DeviceView {
    ...
    function drawButtonHint(dc as Dc) as Void {
        dc.drawText(10, 180, Graphics.FONT_MEDIUM, "+", Graphics.TEXT_JUSTIFY_LEFT);
        dc.drawText(34, 260, Graphics.FONT_MEDIUM, "-", Graphics.TEXT_JUSTIFY_LEFT);
        dc.drawLine(-10, 160, 50, 210);
        dc.drawLine(50, 210, 50, 300);
        dc.drawLine(50, 300, 34, 330);
    }
