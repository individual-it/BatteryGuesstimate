...
class DeviceView {
    var Y_ZERO_LINE as Integer = 170;
    var X_MARGIN_LEFT as Integer = 55;
    var STATS_FONT as Graphics.FontDefinition = Graphics.FONT_TINY;
    var STATS_X_ALLINGMENT as Integer  = 145;
    var STATS_ICON_X_ALLINGMENT as Integer  = 65;
    var STATS_Y_START as Integer  = 4;
    var STATS_LINE_HIGHT as Integer  = 15;
    var STATS_GROUP_PADDING as Integer  = 3;
    var STATS_MIN_MAX_ARROW_TOP as Integer = 13;
